...
const pokemonMockData_1 = require("../../tests/pokemonMockData");
...
describe('Average weight and height functions', () => {
    describe('averageWeightAndHeight', () => {
        ...
        it('should return average for all pokemons passed', () => {
            const results = (0, averageWeightAndHeight_1.averageWeightAndHeight)(pokemonMockData_1.pokemonMockData);
            expect(results).toBeDefined();
            expect(results).toMatchObject({
                averageWeight: 357.8,
                averageHeight: 10.5,
    ...
    describe('averageWeightAndHeightByType', () => {
        ...
        it('should return average for all pokemons passed sorted and ordered by type', () => {
            const results = (0, averageWeightAndHeight_1.averageWeightAndHeightByType)(pokemonMockData_1.pokemonMockData);
            expect(results).toBeDefined();
